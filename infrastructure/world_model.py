...
class WorldModel:
    ...
    side = None
    uniform_number = None
    play_mode = PlayModes.BEFORE_KICK_OFF
    view_width = None
    view_quality = None
    stamina = None
    effort = None
    ...
    turn_count = None
    say_count = None
    turn_neck_count = None
    catch_count = None
    move_count = None
    change_view_count = None
    ...
    def cluster_points(self, points, num_cluster_iterations=15):
        ...
        centers = set([])
        for _ in range(int(math.sqrt(len(points) / 2))):
        ...
        latest = {}
        cur = {}
        for _ in range(num_cluster_iterations):
...
class ServerParameters:
    ...
    def __init__(self):
        ...
        self.log_times = 0
        self.max_back_tackle_power = 0.0
        self.max_catch_angle = 100
        self.max_dash_angle = 180
        self.max_dash_power = 100
        self.max_tackle_power = 100
        self.min_catch_angle = 1
        self.min_dash_angle = -180
        self.min_dash_power = -100
